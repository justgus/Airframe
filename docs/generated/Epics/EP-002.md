...
**Acceptance Criteria:**
- EP-002-AC-01: AirframeCore loads valid sample configuration.
- EP-002-AC-02: AirframeCore rejects malformed configuration with structured errors.
- EP-002-AC-03: AICockpit displays current workspace/project context.
- EP-002-AC-04: AgileCockpit displays current workspace/project context.
- EP-002-AC-05: Core, CLI, and app tests cover the sample configuration path.
