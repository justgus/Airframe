...
**Acceptance Criteria:**
- EP-021-AC-01: AirframeCore defines canonical records for requirements, revisions, trace links, test evidence summaries, deviations, waivers, release scopes, and release gates.
- EP-021-AC-02: Requirements can be imported from and exported to CSV.
- EP-021-AC-03: Requirements can be imported from and exported to canonical JSON.
- EP-021-AC-04: Import dry runs report created, updated, unchanged, removed, and conflicted records before mutation.
- EP-021-AC-05: AirframeCore can identify traceability gaps for in-scope requirements.
- EP-021-AC-06: Test evidence summaries can link test outcomes to requirement IDs and optional CI artifacts.
- EP-021-AC-07: AgileCockpit shows release candidate gate status, including implemented, verified, validated, deferred, waived, and blocked requirement counts.
- EP-021-AC-08: AirframeCore can explain why a release candidate can or cannot close.
- EP-021-AC-09: Generated traceability and compliance documents can be produced from canonical state using deterministic default layouts or provided templates.
- EP-021-AC-10: Tests cover import/export, traceability diagnostics, release gate evaluation, and evidence-to-requirement linking.
...
| T-0135 | Implemented - Verified |
| T-0136 | Implemented - Verified |
| T-0137 | Implemented - Verified |
