...
**Acceptance Criteria:**
- EP-003-AC-01: LLM actor can perform allowed proposal/evidence operations.
- EP-003-AC-02: LLM actor cannot perform human-only operations.
- EP-003-AC-03: Project mismatch is denied by default.
- EP-003-AC-04: Denied operations return deterministic reason codes.
- EP-003-AC-05: Audit records are created for allowed and denied write attempts.
- EP-003-AC-06: CLI and app both display denial information without duplicating policy logic.
...
| T-0016 | Implemented - Verified |
| T-0017 | Implemented - Verified |
