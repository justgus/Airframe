...
**Evidence:**
- AgileCockpit shows close eligibility rows, disabled close buttons, and distinct blocked/success/failure status messages.
- Sprint and Epic close tests cover blocked and successful close messaging.
